   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-blue-900 dark:bg-gray-800">
      <ul class="space-y-2">
		 ...
		 <a class="flex items-center w-full px-3 mt-3" href="#">
			<img src="/pictures/itslogo.png" class="w-8 h-8 fill-current" alt="">
			<span class="ml-2 text-sm font-bold">Tower ITS</span>
		</a>
         </li>
         <li>
		 <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('admin') ? 'active': '';}}" href="{{route('dashboardAdmin')}}">
         ...
         <li>
		 <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('list-reservasi') ? 'active': '';}}" href="{{route('listReservasi')}}">
				<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
         ...
         <li>
		 <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('viewClass', '||', 'viewClass/Lantai4', '||', 'viewClass/Lantai5', '||', 'viewClass/Lantai6', '||', 'viewClass/Lantai7', '||', 'viewClass/Lantai8') ? 'active': '';}}" href="{{route('viewClass')}}">
				<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
         ...
         <li>
		 <a class=" flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('full-calendar') ? 'active': '';}}" href="{{route('full-calendar')}}">
				<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
         ...
         <li>
            <div class="flex flex-col items-center w-full mt-2 border-t border-white-700">
				...
				<form class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300" action="{{route('logout.post')}}" method="POST">
					@csrf
					<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
