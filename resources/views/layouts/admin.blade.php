...
<aside id="sidebar" class="fixed top-0 left-0 z-10 w-64 h-screen transition-transform -translate-x-full md:translate-x-0 text-gray-50" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-blue-900 dark:bg-gray-800">
      <ul class="space-y-2">
         ...
         <li>
		 <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('list-reservasi') ? 'active': '';}}" href="{{route('list-reservasi')}}">
				<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
         ...
         <li>
		 <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-blue-700 hover:text-gray-300 {{ Request::is('view') ? 'active': '';}}" href="{{route('viewClass')}}">
				<svg class="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 55" fill="currentColor">
